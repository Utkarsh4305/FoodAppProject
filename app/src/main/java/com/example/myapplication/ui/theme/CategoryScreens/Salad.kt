...
@Composable
fun SaladScreen(navController: NavHostController) {
    ...
    LaunchedEffect(Unit) {
        coroutineScope.launch {
            products = fetchProductsFromFirestoreSalad()
            isLoading = false
    ...
    Column(modifier = Modifier
        ...
        TextField(
            ...
            placeholder = { Text(text = "Search Salads") },
...
suspend fun fetchProductsFromFirestoreSalad(): List<Uploading> {
...
@Composable
fun SaladScreenPreview() {
    SaladScreen(navController = rememberNavController())
}
